...
<footer class="container-fluid bd-black text-light py-5 ">
        ...
        <div class="row col-xl-11 mx-xl-auto mx-0  px-0">
            ...
            <div class="col-lg-6 mt-lg-0 mt-4 col-md-9 mx-auto text-center row list-st">
                ...
                <ul class="col-4 text-left p-0">
                    <p style="font-family: Montserrat; font-weight: 600;">COMPANY</p>
                    <li class="mb-1"><a href="/">Home</a></li>
                    <li class="mb-1"><a href="/ContactUs">Contact Us</a></li>
                    <li class="mb-1"><a href="/This-is-us">This is us</a></li>
                    <li class="mb-1"><a href="/blog">Blog</a></li>
                </ul>

                <ul class="col-4 text-left p-0">
                    <p style="font-family: Montserrat; font-weight: 600;">SERVICES</p>
                    <li class="mb-1"><a href="/Analytics">Analytics</a></li>
                    <li class="mb-1"><a href="/GraphicDesign">Graphic Design</a></li>
                    <li class="mb-1"><a href="/WebDesign">WebDesign</a></li>
                    <li class="mb-1"><a href="/DigitalMarketing">Digital Marketing</a></li>
                    <li class="mb-1"><a href="/ECommerceSolution">E-Commerce Solution</a></li>
                    <li class="mb-1"><a href="/Software">Software</a></li>
                    <li class="mb-1"><a href="/LeaderShip">LeaderShip</a></li>
                    <li class="mb-1"><a href="/DigitalMarketingAcademy">Digital Marketing Academy</a></li>
                    <li class="mb-1"><a href="/Academy">Rewardlion Academy</a></li>
                </ul>

                <ul class="col-4 text-left p-0">
                    <p style="font-family: Montserrat; font-weight: 600;">ABOUT</p>
                    <li class="mb-1"><a href="/Aboutus#Global">Global</a></li>
                    <li class="mb-1"><a href="/Aboutus#Innovation">Innovation</a></li>
                    <li class="mb-1"><a href="/Aboutus#Precision">Business Solutions</a></li>
                </ul>
            ...
            <div class="col-lg-3 col-md-6 mx-auto mt-lg-0 mt-4 text-center sub-ou">
                ...
                <form class="ajaxForm mb-5" action="/api/v1/subscribe.php
                  " id="newsForm">
                    ...
                    <input type="hidden" value="418661" name="tag">
                    <input type="hidden" value="d7772186fd" name="list">
                    <button class="btn btn-footer">Subscribe</button>
                </form>

                <h5 class="mb-3 text-left" style="font-family: Montserrat; font-weight: 600; font-size: 16px;">Follow
                ...
                <span class="reg-font light-gray" style="font-size:12px;">© All Rights Reserved RewardLion 2020
                </span>
