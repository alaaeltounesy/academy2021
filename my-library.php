...
<body>
    ...
    <section class="bd-black pb-5">
        <div class="w-100 text-center py-5">
            <h1 class="bbblue-col text-uppercase d-lg-block d-none mb-0 bold-font">
                MY LIBRARY
            </h1>
        </div>
        ...
        <div class="container-fluid mt-5  ">
            <div class="row col-md-10 text-center pt-5 text-light mx-auto ">
