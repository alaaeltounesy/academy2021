        ...
        <div class="container-fluid mt-5  ">
            ...
            <div class="row col-md-10  text-center text-light mx-auto px-xl-5 ">
                ...
                <div class="col-12 p-md-5 p-3 row mx-0 box-white">
                    <img src="/themes/<?php echo sitedata('site_theme') ?>/assets/img/bestseller.png" class="sale-img">
                    <div class="col-lg-4 col-8 my-lg-0 my-5 mx-auto">
                        <img class="w-100" src="/themes/<?php echo sitedata('site_theme') ?>/assets/img/revbook.png">
                    ...
                    <div class="col-lg-8 my-auto px-0  text-center">
                        <div class="my-auto">
                            ...
                            <h1 class="abil-font yellow-col text-left display-2 mb-xl-5">
                                Rise
                            </h1>
                            <p class="MediumItalic text-light h5 px-md-4">
                                Get your copy of the digital marketing revolution <br>
                                and show your self to the world …
                            </p>
                        </div>
                    </div>
