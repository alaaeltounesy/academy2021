        ...
        <div class="container-fluid mt-5  ">
            ...
            <div class="row col-md-10  text-center text-light mx-auto px-xl-5 ">
                ...
                <div class="col-12 p-md-5 p-3 row mx-0 box-white">
                    <img src="/themes/<?php echo sitedata('site_theme') ?>/assets/img/free.png" class="sale-img">
                    <div class="col-lg-4 col-8 my-lg-0 my-5 mx-auto">
                        <img class="w-100" src="/themes/<?php echo sitedata('site_theme') ?>/assets/img/analbook.png">
                    ...
                    <div class="col-lg-8 my-auto text-center">
                        <div class="my-auto">
                            ...
                            <h1 class="abil-font sky-col text-left display-2 mb-xl-5 mb-4">
                             Learn
                            </h1>
                            <p class="MediumItalic h5 px-md-4">
                            Even if you know nothing about digital marketing analytics, digital marketing analytics knows plenty about you and with this book, you will !
